        ...
        for test_type_num = 1:len(test_types)
            ...
            if strcmp(test_type,'independent')
                ...
                if exist([results_path 'konvid1k_iv3_results_' ft_type '_ft_' test_type '_tests_' num2str(baseseed) '.mat'],'file')
                    ...
                    save([results_path 'konvid1k_iv3_results_' ft_type '_ft_' test_type '_tests_' num2str(baseseed) '.mat'],'PLCC','SROCC','KROCC','YPRED','YTEST','TrainVideos','ValidationVideos','TestVideos'); 
                end
                
                disp([' --- Results for ' test_type ' Test Set: ' num2str(round(SROCC.avg,3)) ' SROCC --- '])
            else
                ...
                if exist([results_path 'konvid1k_iv3_results_' ft_type '_ft_' test_type '_tests_' num2str(baseseed) '.mat'],'file')
                    ...
                    for j=1:num_svrs
                        ...
                        [PLCC{j}, SROCC{j}, KROCC{j}, YPRED{j}, YTEST{j}] = svrpredictvqa(TrainVideos, ValidationVideos, TestVideos, Name, MOS, actsstruct);
                    end
